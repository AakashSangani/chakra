...
<section id="landing-page">
    <div id="intro-section" class="py-10">
        <section class="container mx-auto">
            <div class="flex ">
                <div class="intro p-8" class="w-9/12">
                    <h1 class="h1 mb-2">Your best is yet to be told!</h1>
                    <h3 class="h3">Your best is an idiot! So I really am important? How I feel
                        when I’m drunk is correct.</h3>
                    <button>Get in touch</button>
                </div>
                <div id="logo" class="w-3/12 p-6">
                    <img class="bg-black w-40 h-40" src="" alt="">
                </div>
            </div>
        </section>
